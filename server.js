...
const LEGAL_KEYWORDS = [
  ...
  // Courts & procedure (missing before)
  "ابتدائية","استئنافية","ابتدائي","استئنافي","قضائي","قضاء","محاكم","جلسة","تقاضي",
  "دعوه","دعوى","نزاع","خلاف","مطالبة","محضر","تبليغ","توكيل","أمر","إجراءات",
  "حكم ابتدائي","طعن","إيداع","مستأنف","أجل","موعد","القضية","مراسلة","الدفاع",
  // Property & real estate (missing before)
  "منزل","بيت","شقة","ارض","ملك","حصة","قسمة","شيوع","تقسيم","مشترك",
  "اشترى","اشتريت","باع","بيع المنزل","إشهاد","توثيق","رسم عقاري","مسطرة التحفيظ",
  // Family & inheritance (expanded)
  "زوجته","زوجها","زوج","زوجة","ابناء","اولاد","قاصر","بالغ","ثلث","نصيب",
  "إرث","وراثة","تركة","وصية","قسمة التركة","التركة","الميراث","الحصة",
  ...
  "دار","مولاها","فالمحكمة","القاضي","المحامي","الملف","الدوسيه","القسمة",
];
